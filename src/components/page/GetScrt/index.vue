<template>
  <column mode="full" class="get-scrt-page">
    ...
    <column
      class="spacer-s get-scrt__bg-black"
      number="2"
      number-m="1"
      number-s="1"
    >
      <block>
        <div>
          <img
            ...
            src="/img/get-scrt/get-scrt-coin.png"
            alt="Secret coin"
            loading="lazy"
          />
        </div>
      ...
      <block class="get-scrt__block-align">
        <div>
          ...
          <p class="get-scrt__p-left">
            Secret (SCRT) is a cryptocurrency and the native coin of the Secret
            Network blockchain. Just like Ether (ETH) and Bitcoin (BTC), you
            hold your Secret (SCRT) in a wallet and spend it when you want to
            use Secret Network. You can also stake it or use it to participate
            in governance.
          </p>
        </div>
      </block>
      ...
      <block class="">
        <div class="get-scrt__text-block">
          ...
          <p class="get-scrt__p">
            ...
            solutions, browsers extensions, and mobile wallets.
          </p>
        </div>
              ...
              <defs>
                ...
                <clipPath id="clip1_4823_129025">
                  <rect
                    ...
                    height="24"
                    fill="white"
                    transform="translate(0.672852)"
                  />
                </clipPath>
              </defs>
            </svg>
            <p class="get-scrt__privacy__text-box__p">
              Want to set up a completely private wallet that can’t be linked to
              your identity in any way? Check out
              <a
                href="https://medium.com/@secretnetwork/secret-network-access-control-viewing-keys-vs-permits-97baad539e72"
                >this tutorial</a
              >
              to find out how.
            </p>
...
<style lang="scss">
.--flare-page .get-scrt-page > .--flare-block > .content > .box {
  padding: 0;
}
</style>
