<template>
  <section class="page-developer-second">
    <div
      class="page-developer-second__content"
      v-for="(item, index) in material"
      :key="index"
    >
      <div class="page-developer-second__content__info">
        <h3>{{ item.title }}</h3>
      ...
      <div class="page-developer-second__content__img">
