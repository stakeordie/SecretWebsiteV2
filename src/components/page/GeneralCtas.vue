  ...
  data() {
    return {
      ctas: [
        ...
        // ECOSYSTEM
        {
          ctaId: "see-whats-been-built",
          imageUrl: "/img/about-secret-network/ecosystem-cta-img.png",
          title: "See what’s been built",
          description:
            "Check out the current ecosystem of Secret Network DApps, tools, and products.",
