  ...
  <div>
    <div class="all-media">
      ...
      <div class="media-items">
        ...
        <div class="items">
          <div v-bind:key="`${media.title}`" v-for="media in filteredCategories" class="item" :class="`accent-${media.category}`">
            <a :href="media.url">
  ...
  export default {
    ...
    computed: {
      ...
      filteredCategories() {
        ...
        return this.mediaItems.filter(it => this.selectedCategories.includes(it.category));
      }
    },
